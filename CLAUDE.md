...
### 3. 前端:**当前保持 Vue 2 + ant-design-vue 1.x**,2.0 版本再做 Vue 3 SPA
- 现状:Go template + Vue 2.6.12 + ant-design-vue 1.7.2(非 SPA),~2200 行 HTML
- Vue 3 SPA 完整迁移清单见:[`docs/vue3-spa-migration.md`](docs/vue3-spa-migration.md)
- **不要走中间路线**(一半 SPA 一半 template)——鉴权/路由/资源会全部混乱
- 触发重构的条件:UI 设计规范统一压力 / Vue 2 出现安全问题 / 移动端体验成阻塞点
